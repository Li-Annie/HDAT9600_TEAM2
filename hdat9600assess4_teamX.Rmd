...
```
_The 3 analysis of deviance test suggest there are only 4 significant predictors of deaths in hospital as suggested by AIC and these are ICU type, age, SOFA scores and minimum respiration rate. 
...
ggplot(aes(x=predicted_probability_bin, 
  ...
  geom_point() + geom_linerange(colour="blue", alpha=0.3) + geom_abline(intercept=0, slope=1) +
...
ggplot(aes(x=predicted_probability_bin, 
           ...
           ymin=in_hospital_death_bin/n_bin - 1.96*se_predicted_probability_bin,
           ymax=in_hospital_death_bin/n_bin + 1.96*se_predicted_probability_bin)) +
  geom_point() + geom_linerange(colour="blue", alpha=0.5) + geom_abline(intercept=0, slope=1) +
  labs(x="Predicted probability (binned)",
