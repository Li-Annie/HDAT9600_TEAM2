...
I selected the predictor variables (age, length of stay, ICU type, SOFA score, fractional inspired O2, Glasgow Coma Score, heart rate and Mechanical ventilation respiration) to predict the risk of in-hospital death.
...
names(which(colSums(! is.na(icu_patients_df1)) < 2061))
