...
```{r coxmod_mv_uni_redc}
# According to the summary of coxmod_uni, use only significant vars.
coxmod_mv_uni_redc <- coxph(surv_object_c ~ Age + HR_diff + RespRate_diff + SysABP_diff + Temp_max + GCS_max + GCS_diff + Urine_max + Urine_diff + Lactate_diff + Creatinine_diff + Na_diff, data=icu_sub2c)
...
```{r}
propmv2 <- cox.zph(coxmod_mv_redc)
propmv2
```
